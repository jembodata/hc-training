                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div class="min-w-0">
                        ...
                        <flux:text class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
                            @if ($mode === 'create')
                                Lengkapi informasi training dan jadwal sesi.
                            @elseif ($mode === 'add')
                    ...
                    <div class="min-w-0 space-y-5">
                        <flux:card size="sm" class="space-y-5">
                            ...
                            <flux:field>
                                ...
                                <flux:input
                                    ...
                                    size="sm"
                                    class="text-sm"
                                    :disabled="in_array($mode, ['add', 'edit'], true)"
                                />
                            ...
                            @if (in_array($mode, ['create', 'edit-standalone'], true))
                        ...
                        <flux:card size="sm" class="space-y-5">
                            <div class="flex items-start justify-between gap-4">
                                <div class="min-w-0">
                                    <flux:heading size="sm" class="font-semibold">
                                        {{ $mode === 'edit-standalone'
                                            ? 'Jadwal training'
                                            : 'Sesi training' }}
                                    </flux:heading>

                                    <flux:text class="mt-1 text-xs">
                                        @if ($mode === 'edit-standalone')
                                ...
                                @foreach ($batches as $index => $batch)
                                    ...
                                    >
                                        <div class="flex items-center justify-between gap-3">
                                            ...
                                            @if (!$training_id && count($batches) > 1)
                                                <flux:button
                                                    type="button"
                                                    variant="ghost"
                                                    size="sm"
                    ...
                    <div class="min-w-0 space-y-5 xl:sticky xl:top-0">
                        <flux:card size="sm" class="space-y-5">
                            <div>
                                ...
                                <flux:text class="mt-1 text-xs">
                                    @if ($mode === 'add')
                                        Konfigurasi mengikuti training group.
                                    @elseif ($mode === 'edit-standalone')
                                        Berlaku untuk training standalone ini.
                                    @else
