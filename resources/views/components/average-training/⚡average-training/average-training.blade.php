<div id="average-training-content" class="w-full space-y-6 antialiased">
    <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            @can(\App\Support\Auth\Permissions::EXPORT_AVERAGE_TRAINING)
    ...
    <flux:card class="space-y-5 overflow-visible">
        ...
        <div wire:loading.class="opacity-50" wire:target="year"
            ...
            <flux:table>
                <flux:table.columns>
                    <flux:table.column
                        class="sticky left-0 z-20 min-w-[240px] text-xs font-semibold">
                        Department
                    </flux:table.column>
                ...
                <flux:table.rows>
                    @forelse ($rows as $row)
                        <flux:table.row wire:key="average-training-{{ $row['organization_id'] }}">
                            <flux:table.cell class="sticky left-0 z-10">
