...
<body class="min-h-screen bg-white antialiased dark:bg-zinc-800">
    ...
    >
        ...
        <flux:sidebar.nav>
            ...
            @canany([
                \App\Support\Auth\Permissions::VIEW_TRAINING_DETAIL,
            ...
            @canany([
                ...
                \App\Support\Auth\Permissions::VIEW_USER,
                \App\Support\Auth\Permissions::VIEW_ROLE,
                \App\Support\Auth\Permissions::VIEW_DEPARTMENT_POSITION_DATA,
            ])
                <flux:sidebar.group
                    heading="Data"
                    icon="circle-stack"
