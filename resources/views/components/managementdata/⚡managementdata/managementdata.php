...
new class extends Component
{
    ...
    {
        Gate::authorize(Permissions::VIEW_DEPARTMENT_POSITION_DATA);
    }
    ...
    {
        Gate::authorize(Permissions::CREATE_DEPARTMENT_POSITION_DATA);
    ...
    {
        Gate::authorize(Permissions::UPDATE_DEPARTMENT_POSITION_DATA);
    ...
    {
        Gate::authorize(Permissions::DELETE_DEPARTMENT_POSITION_DATA);
